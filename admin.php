...
<tr>
<td align="center" valign="bottom"><img src="sandhyaproj.png" width="1000"
height="184"></td>
</tr>
<tr>
...
<tr>
<td width="240" height="302" valign="top"><p class="font-verdana"><img src="imag2jp.jpg"></p></td>
...
<tr>
<td align="center" valign="top"><form name="form1" method="post" action="admin-db.php">
...
<tr>
<td>Administrator unique id</td>
<td width="3%">&nbsp;</td>
<td width="51%"><label for="textfield"></label>
<input type="text" name="unique_id" id="unique_id"></td>
</tr>
<tr>
<td>Administrator unique password</td>
<td>&nbsp;</td>
<td><label for="textfield3"></label>
<input type="text" name="unique_password" id="unique_password"></td>
</tr>
<tr>
<td>Administrator Name</td>
<td>&nbsp;</td>
<td><label for="textfield2"></label>
<input type="text" name="unique_name" id="unique_name"></td>
</tr>
<tr>
<td>Administrator&nbsp; Email Id</td>
<td>&nbsp;</td>
<td><label for="textfield4"></label>
<input type="text" name="unique_email" id="unique_email"></td>
</tr>
<tr>
<td>Administrator Contact No</td>
<td>&nbsp;</td>
<td><label for="textfield5"></label>
<input type="text" name="unique_contactno" id="unique_contactno"></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
