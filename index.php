        ...
        <tr>
            <td align="center" valign="top" bgcolor="#FFFFFF">
                <table width="1000" border="0" id="Main">
                    <tr>
                        <td align="center" valign="bottom"><img src="complain-banner-eng.jpg" width="1000" height="184"></td>
                    </tr>
                    <tr>
                            ...
                            <table width="1000" height="306" border="0" bgcolor="#FFFFFF">
                                <tr>
                                    <td width="240" height="302" valign="top">
                                        <p class="font-verdana"><img src="images.jpg"></p>
                                    </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="font-verdana">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="justify" valign="top">
                                                                                <p>The proposed project title is which is developing to fulfill the dream of making Complain system through web. This system is introduced to provide security to our citizens. If they face any problem or want to complain related to security, they can easily use our system. <br>
                                                                                So, I decided to develop a web system related to Public Security and Complain Management. Any public can register with this system. After successful registration, they can share feedback related to security, share views and suggestions, inform us if they see any suspect person or activity, directly complain to us, and much more. The main idea is that we provide complain & security support related to their location. They don't have to go anywhere; just open our portal, register themselves as per norms, and register the complaint. We will not disclose their identity in any case. After the introduction and development of this system, we can support our society, provide a flexible platform to our citizens/public, and contribute to our nation. </p>
                                                                            </td>
                                                                            <td>&nbsp;</td>
                                                                        </tr>
                                                                        <tr>
                    ...
                    <tr>
                        <td align="center" valign="middle" bgcolor="#FFFF00">
                            ...
                            <table width="100%" border="0" cellspacing="20" cellpadding="20">
                                <tr>
                                    <td align="center" valign="middle"><strong><em>All rights reserved | Copyright Protected</em></strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
