                            ...
                            <table width="1000" height="306" border="0" bgcolor="#FFFFFF">
                                <tr>
                                    <td width="240" height="302" valign="top">
                                        <p class="font-verdana"><img src=""></p>
                                    </td>
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <form name="form1" method="post" action="newuser-db.php">
                                                                            ...
                                                                            <td align="center" valign="top">
                                                                                <table width="100%" border="0">
                                                                                    <tr>
                                                                                        <td>User Name</td>
                                                                                        <td width="3%">&nbsp;</td>
                                                                                        <td width="51%"><input type="text" name="user_name" id="user_name"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>User unique password</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td><input type="text" name="user_uniq_password" id="user_uniq_password"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>User sex</td>
                                                                                        <td>&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>&nbsp;</td>
                                                                                        <td><input type="text" name="user_dob" id="user_dob"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>User Address</td>
                                                                                        <td>&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>&nbsp;</td>
                                                                                        <td><input type="text" name="user_contactno" id="user_contactno"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Complain Details</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td><input type="text" name="complain" id="complain"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>&nbsp;</td>
