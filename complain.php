                                        ...
                                        <table width="100%" border="0">
                                            <tr>
                                                <td height="23" align="center" valign="top" bgcolor="#FFFF00" class="font-verdana">
                                                    <strong><h1>COMPLAIN MANAGEMENT</h1></strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" valign="top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <form name="form1" method="post" action="complain-db.php">
...
mysql_select_db("complaindirectory", $con) or die ("Could not select database");

$sql = "INSERT INTO complain_table(f1, f2, f3, f4, f5, f6, f7) " .
       "VALUES ('$f1', '$f2', '$f3', '$f4', '$f5', '$f6', '$f7')";

$result = mysql_query($sql, $con) or die("Query execution failed: " . mysql_error());
