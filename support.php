...
<tr>
<td width="240" height="302" valign="top"><p class="font-verdana"><img src="suppimagjp.jpg"></p></td>
...
<tr>
<td align="center" valign="top"><form name="form1" method="post" action="support-db.php">
...
<tr>
<td>Name of Complain</td>
<td width="3%">&nbsp;</td>
<td width="51%"><label for="textfield"></label>
<input type="text" name="title" id="title"></td>
</tr>
<tr>
<td>Support Person Name</td>
<td>&nbsp;</td>
<td><label for="textfield3"></label>
<input type="text" name="sup_p_name" id="sup_p_name"></td>
</tr>
<tr>
<td>Date</td>
<td>&nbsp;</td>
<td><label for="textfield2"></label>
<input type="text" name="c_date" id="c_date"></td>
</tr>
<tr>
<td>Complain</td>
<td>&nbsp;</td>
<td><label for="textfield4"></label>
<input type="text" name="complain" id="complain"></td>
</tr>
<tr>
<td>Solution</td>
<td>&nbsp;</td>
<td><label for="textfield5"></label>
<input type="text" name="solution" id="solution"></td>
</tr>
<tr>
<td>Public Email Id (for Details Send)</td>
<td>&nbsp;</td>
<td><label for="textfield6"></label>
<input type="text" name="public_email" id="public_email"></td>
</tr>
<tr>
<td>Public Contact No (for Details Send)</td>
<td>&nbsp;</td>
<td><label for="textfield7"></label>
<input type="text" name="public_contactno" id="public_contactno"></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
