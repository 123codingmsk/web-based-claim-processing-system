...
<tr>
<td width="240" height="302" valign="top"><p class="font-verdana"><img src="imag4jp.jpg"></p></td>
...
<tr>
<td align="center" valign="top"><form name="form1" method="post" action="feedback-db.php">
...
<input type="text" name="feedback" id="feedback"></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
