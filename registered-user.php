                                        ...
                                        <table width="100%" border="0">
                                            <tr>
                                                <td height="23" align="center" valign="top" bgcolor="#FFFF00" class="font-verdana">
                                                    <strong><h1>REGISTERED USER</h1></strong>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <form name="form1" method="post" action="registered_user-db.php">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" valign="top">
                                                                                <table width="100%" border="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>Public unique password</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
                                                                                            <input type="text" name="public_uniq_password" id="public_uniq_password">
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Public sex</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
                                                                                            <input type="text" name="public_sex" id="public_sex">
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Public Date of Birth</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
                                                                                            <input type="text" name="public_dob" id="public_dob">
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>Public Email Id</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
                                                                                            <input type="text" name="public_email" id="public_email">
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Public Contact No</td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
                                                                                            <input type="text" name="public_contactno" id="public_contactno">
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="right">
                                                                                            <input name="btnsubmit" type="submit" id="btnsubmit" onClick="MM_popupMsg('Implemented Successfully !! for any query contact us')" value="Submit">
                                                                                        </td>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
...
$sql = "INSERT INTO registereduser_table (f1, f2, f3, f4, f5, f6, f7, f8) VALUES ('$f1', '$f2', '$f3', '$f4', '$f5', '$f6', '$f7', '$f8')";
